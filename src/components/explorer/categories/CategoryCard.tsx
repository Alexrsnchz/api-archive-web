...
export default function CategoryCard({ category, selectCategory }: CategoryCardProps) {
  ...
  return (
    <article
      ...
      className="flex flex-col justify-center items-center gap-3 py-8 md:py-10 rounded-lg hover:shadow-[0_0_30px_rgba(139,92,246,0.5)] group cursor-pointer border border-neutral-800 hover:bg-midnight-400/80 hover:-translate-y-2 transition-all duration-300 ease-in-out"
    >
      ...
      <div className="flex flex-col items-center">
        <span className="font-semibold text-lg text-neutral-200 group-hover:text-neutral-100">
          {category.name}
        </span>
