  ...
  return (
    <section className="pt-8 pb-16 md:pt-10 md:pb-20 lg:pt-25 lg:pb-50">
      <div className="flex flex-col items-center">
        ...
        <p className="mt-3 md:mt-5 mx-auto max-w-xs md:max-w-lg lg:max-w-2xl text-center text-md md:text-md lg:text-lg text-neutral-400">
        ...
        >
          <GitHubIcon className="size-6 text-neutral-200" />
