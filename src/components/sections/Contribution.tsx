  ...
  return (
    <section className="pt-8 pb-16 md:pt-10 md:pb-20 lg:pt-25 lg:pb-50">
      <div className="flex flex-col items-center">
        <h2 className="text-4xl font-bold text-neutral-100">Help Grow the Archive</h2>

        <p className="mt-5 mx-auto max-w-2xl text-center text-sm md:text-md lg:text-lg text-neutral-400">
